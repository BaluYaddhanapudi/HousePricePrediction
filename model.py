...
train = pd.read_csv('/Users/gopi/Desktop/GP Python/Hackathon2/house-prediction/data/train.csv')
test = pd.read_csv('/Users/gopi/Desktop/GP Python/Hackathon2/house-prediction/data/test.csv')
